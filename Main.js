...
setInterval(function(){
    ...
    StartServer.style.left = ScreenWidth - ScreenWidth / 5 + 'px';
    ...
    StopServer.style.left = ScreenWidth - ScreenWidth / 5 + 'px';
    ...
    RestartServer.style.left = ScreenWidth - ScreenWidth / 5 + 'px';
